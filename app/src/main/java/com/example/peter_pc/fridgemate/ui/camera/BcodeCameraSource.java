 ...
 * {@link BcodeCameraSource.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class BcodeCameraSource {
    ...
    public static class Builder {
        ...
        private BcodeCameraSource mBcodeCameraSource = new BcodeCameraSource();
        ...
        public Builder(Context context, Detector<?> detector) {
            ...
            mDetector = detector;
            mBcodeCameraSource.mContext = context;
        }
        ...
        public Builder setRequestedFps(float fps) {
            ...
            mBcodeCameraSource.mRequestedFps = fps;
            return this;
        }

        public Builder setFocusMode(@FocusMode String mode) {
            mBcodeCameraSource.mFocusMode = mode;
            return this;
        }

        public Builder setFlashMode(@FlashMode String mode) {
            mBcodeCameraSource.mFlashMode = mode;
            return this;
        }
        ...
        public Builder setRequestedPreviewSize(int width, int height) {
            ...
            mBcodeCameraSource.mRequestedPreviewWidth = width;
            mBcodeCameraSource.mRequestedPreviewHeight = height;
            return this;
        }
        ...
        public Builder setFacing(int facing) {
            ...
            mBcodeCameraSource.mFacing = facing;
            return this;
        }
         ...
         */
        public BcodeCameraSource build() {
            mBcodeCameraSource.mFrameProcessor = mBcodeCameraSource.new FrameProcessingRunnable(mDetector);
            return mBcodeCameraSource;
        }
    }
    ...
    public BcodeCameraSource start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public BcodeCameraSource start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
